...
function rubine_customize_controls_js() {
	...
	wp_localize_script( 'rubine-lite-customizer-controls', 'rubine_theme_links', array(
		...
		'themeURL'	=> esc_url( 'https://themezee.com/themes/rubine/?utm_source=customizer&utm_medium=textlink&utm_campaign=rubine&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'rubine-lite' ),
		'docuURL'	=> esc_url( 'https://themezee.com/docs/rubine-documentation/?utm_source=customizer&utm_medium=textlink&utm_campaign=rubine&utm_content=documentation' ),
